...
//											EasyThumbnailImage::THUMBNAIL_OUTBOUND, ['class' => 'grid-item__img']); ?>
										<?php Imagick::open(Yii::getAlias('@frontend/web/uploads/global'.basename($value['file'])))->resize(510, false)->saveTo(Yii::getAlias('@frontend/web/uploads/thumbnail/'.basename($value['file'])));?>
