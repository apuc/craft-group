								...
								<?php if($i <= $count - 1):?>
									<div class="grid-item">
										...
										<div class="grid-item__links">
											...
											<a data-pin-do="buttonPin" href="https://www.pinterest.com/pin/create/button/" data-pin-custom="true"><img src="https://addons.opera.com/media/extensions/55/19155/1.1-rev1/icons/icon_64x64.png"></a>
										</div>
									</div>
								<?php $i++; endif;?>
							<?php endforeach;?>
